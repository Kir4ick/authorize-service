 ...
 */
final class Version20240716202126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "session" (uuid UUID NOT NULL, fingerprint VARCHAR(255) NOT NULL, PRIMARY KEY(uuid))');
